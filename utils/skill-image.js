...
export const skillsImage = (skill) => {
  ...
  switch (skillID) {
    ...
    case 'graphql':
      return graphql;
    case 'getx':
      return flutter; // Using Flutter icon as GetX is a Flutter state management
    case 'provider':
      return react; // Using React icon as Provider is a React/Flutter state management
    case 'rest apis':
      return fastapi; // Using FastAPI icon as placeholder for REST APIs
    case 'google maps':
      return gcp; // Using GCP icon as placeholder for Google Maps
    case 'ci/cd':
      return docker; // Using Docker icon as placeholder for CI/CD
    case 'mvvm':
      return flutter; // Using Flutter icon for MVVM architecture
    case 'clean architecture':
      return flutter; // Using Flutter icon for Clean Architecture
    case 'sqlite':
      return mysql; // Using MySQL icon as placeholder for SQLite
    case 'push notifications':
      return firebase; // Using Firebase icon for push notifications
    case 'payment gateway':
      return aws; // Using AWS icon as placeholder
    case 'state management':
      return react; // Using React icon for state management
    case 'cloud firestore':
      return firebase; // Using Firebase icon for Firestore
    case 'firebase auth':
      return firebase; // Using Firebase icon
    case 'firebase storage':
      return firebase; // Using Firebase icon
    default:
      // Return a default icon (using firebase as placeholder for missing icons)
      return firebase;
  }
}
